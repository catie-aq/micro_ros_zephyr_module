...
DEBUG ?= 0
.ONESHELL: # To get cd working on windows ?
...
get_package_names: $(COMPONENT_PATH)/micro_ros_src/src
	...
	colcon list | gawk "{print $$1}" | gawk -v d=";" "{s=(NR==1?s:s d)$$0}END{print s}"

configure_colcon_meta: $(COMPONENT_PATH)/colcon.meta $(COMPONENT_PATH)/micro_ros_src/src
	sh $(COMPONENT_PATH)\utils.sh
	copy $(COMPONENT_PATH)/colcon.meta $(COMPONENT_PATH)/configured_colcon.meta
	set ZEPHYR_CONF_FILE=%ZEPHYR_CONF_FILE%
...
$(COMPONENT_PATH)/micro_ros_src/src:
	...
	git clone -b jazzy https://github.com/ros2/test_interface_files src\test_interface_files
	...
	copy NUL src\ros2_tracing\test_tracetools\COLCON_IGNORE
	copy NUL src\ros2_tracing\lttngpy\COLCON_IGNORE
	copy NUL src\rosidl\rosidl_typesupport_introspection_cpp\COLCON_IGNORE
	copy NUL src\rclc\rclc_examples\COLCON_IGNORE
	copy NUL src\common_interfaces\actionlib_msgs\COLCON_IGNORE
	copy NUL src\common_interfaces\std_srvs\COLCON_IGNORE
	copy NUL src\rcl\rcl_yaml_param_parser\COLCON_IGNORE
	copy NUL src\rcl_logging\rcl_logging_spdlog\COLCON_IGNORE
	copy NUL src\rcl_interfaces\test_msgs\COLCON_IGNORE
